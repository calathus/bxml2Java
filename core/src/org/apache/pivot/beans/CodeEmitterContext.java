...
public class CodeEmitterContext {
    ...
    public void register_reference(String name, Object value) {
        System.out.println(">> register_reference name: "+name+", value: "+value);
        refMap.put(name, value);
    }

    public String get_reference_name(Object value) {
        ...
        return null;
        //throw new RuntimeException("get_reference_name: no value: "+value);
    }
